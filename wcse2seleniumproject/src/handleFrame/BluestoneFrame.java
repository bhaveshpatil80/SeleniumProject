...
public class BluestoneFrame {
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement usernameTB = driver.findElement(By.xpath("//input[@id='chat-fc-name']"));
		usernameTB.sendKeys("Bhavesh");
		
		WebElement emailTB = driver.findElement(By.xpath("//input[@id='chat-fc-email']"));
		emailTB.sendKeys("patilbhavesh698@gmail.com");
		
		WebElement phoneTB = driver.findElement(By.xpath("//input[@id='chat-fc-phone']"));
		phoneTB.sendKeys("8007011525");
